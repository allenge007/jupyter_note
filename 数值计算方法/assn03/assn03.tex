...
\PY{c+c1}{\PYZsh{} 边界：夹紧条件 S\PYZsq{}(x0)=1, S\PYZsq{}(x63)=S\PYZsq{}(64)=0.6868}
\PY{c+c1}{\PYZsh{} 对左端点}
...
\PY{n}{b\PYZus{}vec}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{6}\PY{o}{*}\PY{p}{(}\PY{n}{d}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{l+m+mf}{1.0}\PY{p}{)}
\PY{c+c1}{\PYZsh{} 对右端点}
...
\PY{n}{b\PYZus{}vec}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{6}\PY{o}{*}\PY{p}{(}\PY{l+m+mf}{0.6868}\PY{o}{\PYZhy{}}\PY{n}{d}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
